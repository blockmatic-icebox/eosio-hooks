...
function TransitProvider(_a) {
    ...
    var accessContext = react_1.useMemo(function () { return eos_transit_1.initAccessContext({
        appName: appname,
        network: {
        ...
        TransitWalletProvider: [eos_transit_scatter_provider_1.default(), eos_transit_scatter_provider_2.default(), eos_transit_lynx_provider_1.default(), eos_transit_meetone_provider_1.default()],
    }); }, [appname]);
    getWallet = function (walletProvider) {
