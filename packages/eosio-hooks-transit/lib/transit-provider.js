...
var getWalletProviders = function(providerList) {
  var supportedProviders = {
    scatter: function() {
      return eos_transit_scatter_provider_1.default();
    },
    tokenpocket: function() {
      return eos_transit_scatter_provider_2.default();
    },
    lynx: function() {
      return eos_transit_lynx_provider_1.default();
    },
    meetone: function() {
      return eos_transit_meetone_provider_1.default();
    },
  };
...
function TransitProvider(_a) {
  ...
  var children = _a.children,
    config = _a.config;
  var _b = react_use_localstorage_1.default('wallet-provider', undefined),
    transitProvider = _b[0],
    setTransitProvider = _b[1];
  var _c = transit_reducer_1.default(),
    state = _c[0],
    dispatch = _c[1];
  var accessContextConfig = react_1.useMemo(
    function() {
  ...
  var accessContext = react_1.useMemo(
    function() {
      return eos_transit_1.initAccessContext(accessContextConfig);
    },
    [accessContextConfig],
  );
  var connectWallet = react_1.useCallback(
    function(provider) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 1:
              ...
              providerIndex = config.providers.findIndex(function(p) {
                return p === provider;
              });
  ...
  var disconnectWallet = react_1.useCallback(
    function() {
  ...
  var connectScatter = react_1.useCallback(
    function() {
      return connectWallet('scatter');
    },
    [connectWallet],
  );
  var connectLynx = react_1.useCallback(
    function() {
      return connectWallet('lynx');
    },
    [connectWallet],
  );
  var connectMeetOne = react_1.useCallback(
    function() {
      return connectWallet('meetone');
    },
    [connectWallet],
  );
  var connectTokenPocket = react_1.useCallback(
    function() {
      return connectWallet('tokenpocket');
    },
    [connectWallet],
  );
  ...
  return react_1.default.createElement(
    transit_context_1.TransitContext.Provider,
    {
      value: {
        connectWallet: connectWallet,
        disconnectWallet: disconnectWallet,
        connectScatter: connectScatter,
        connectLynx: connectLynx,
        connectMeetOne: connectMeetOne,
        connectTokenPocket: connectTokenPocket,
      },
    },
    react_1.default.createElement(
      transit_context_1.TransitStateContext.Provider,
      { value: state },
